					...
					<div class="beta-comp">
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item"><a class="cart-item-delete" href="{{ route('banhang.xoagiohang',$product['item']['id'])}}">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">{{$product['qty']}}*<span>{{$product['item']->promotion_price !=0?number_format($product['item']->promotion_price,0):
												number_format($product['item']->unit_price,0)}} vnđ</span></span>
										</div>
									</div>
								</div>
								...
								<div class="cart-caption">
									<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{isset($totalPrice)?number_format($totalPrice,0):0}} vnđ</span></div>
									<div class="clearfix"></div>
