						...
						<div class="your-order">
							...
							<div class="your-order-item">
									...
									<!--  one item	 -->
										<div class="media">
											...
											<div class="media-body">
												<b><p class="font-large">{{$product['item']->name}}</p></b>
												<span class="color-gray your-order-info">Price: {{$product['qty']}}*<span>{{$product['item']->promotion_price !=0?number_format($product['item']->promotion_price,0):
												number_format($product['item']->unit_price,0)}} vnđ</span>
								...
								<div class="your-order-item">
									...
									<div class="pull-right"><h5 class="color-black">{{isset($totalPrice)?number_format($totalPrice,0):0}}</h5></div>
									<div class="clearfix"></div>
								</div>
							</div>
...
//color
    ...
    jQuery('#style-selector a.close').click(function(e){
      ...
      } else {jQuery('#style-selector').animate({
          left: '-213px'
        });
