					    ...
					    <div class="banner" >
								<ul>
									...
									data-oheight="undefined">
													...
													src="/source/image/slide/{{$slide['image']}}" 
					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{ isset($new_products)?count($new_products):0}} Sản phẩm</p>
								...
								<div class="col-sm-3" >
									<div class="single-item">
										<div class="single-item-header">
											<a href="#"><img src="/source/image/product/{{ $new_product['image']; }}" padding="auto" height="200em" alt=""></a>
										</div>
										<div class="single-item-body">
											<b><p class="single-item-title">{{ $new_product['name']; }}</p></b>
											<p class="single-item-price">
												<span class="flash-del">{{ $new_product['unit_price']; }} vnđ</span>
												<span class="flash-sale">{{ $new_product['promotion_price']; }} vnđ</span>
											</p>
										</div>
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{ route('banhang.addToCart',$new_product->id)}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="product">Chi Tiết Sản Phẩm<i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product"><img src="source/assets/dest/images/products/1.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="product"><img src="source/assets/dest/images/products/2.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
								...
								<div class="col-sm-3" >
									<div class="single-item">
										<div class="single-item-header">
											<a href="product"><img src="source/assets/dest/images/products/3.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">Sample Woman Top</p>
											<p class="single-item-price">
